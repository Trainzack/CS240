...
public class ArrayBagDemo
{
	...
	private static void testIntIsEmpty(BagInterface<Integer> aBag, boolean correctResult)
	{
		System.out.print("Testing isEmpty with ");
		if (correctResult)
			System.out.println("an empty bag:");
